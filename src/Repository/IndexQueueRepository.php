...
final class IndexQueueRepository
{
    ...
    *
    * @param list<string|int> $ids       Element IDs (flat list)
    * @param array<string, mixed> $metaData First row from the query result, used to extract element type, operation, etc.
    *
