...
```
- [Indexing] Introduced new service alias `generic-data-index.search-client`. This alias will replace deprecated tag `generic-data-index.opensearch-client` which will be removed in the next major version.
